# project euler no. 18
#   find the highest-total route from top to bottom in this pyramid:
#   75
#   95 64
#   17 47 82
#   18 35 87 10
...
def max_path(pyramid,y,x):
  if y == 13:
    return pyramid[y][x] + max(pyramid[y+1][x], pyramid[y+1][x+1])
  else:
    return pyramid[y][x] + max(max_path(pyramid,y+1,x),max_path(pyramid,y+1,x+1))
